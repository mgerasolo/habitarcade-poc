 ...
 * Shows inline header with today/month scores and navigation controls.
...
export function Habits() {
  return (
    <div className="h-full flex flex-col" data-testid="habits-page">
      {/* Full-width Habit Matrix - compact vertical mode for max density, with inline header for scores */}
      <div className="flex-1 p-2 overflow-hidden">
        <div className="h-full bg-slate-800/50 rounded-xl border border-slate-700/50 overflow-hidden p-2">
          <HabitMatrix className="h-full" compactVertical showInlineHeader />
        </div>
      </div>
    </div>
  );
