  ...
  return (
    <div className="mb-2">
      ...
      <button
        ...
        className="
          w-full flex items-center gap-2 py-1.5 px-1 -mx-1
          rounded hover:bg-slate-700/30
      ...
      >
        ...
        {/* Category name */}
        <span className="font-condensed text-xs font-semibold text-slate-300 uppercase tracking-wider">
          {categoryName}
        </span>

        {/* Habit count badge */}
        <span className="text-[10px] text-slate-500 font-condensed">
        ...
        <div className="pl-4 border-l border-slate-700/50 ml-1">
          {habits.map((habit) => (
            <RowComponent
              ...
              habit={habit}
              dates={dates}
              habitNameWidth={habitNameWidth - 20} // Account for indent
            />
          ))}
        </div>
      </div>
    ...
    <div className="mb-3">
      ...
      {category && (
        <div className="flex items-center gap-2 py-1 mb-1">
          ...
          <span className="font-condensed text-xs font-semibold text-slate-400 uppercase tracking-wider">
            {categoryName}
          </span>
      ...
      {/* Habit rows */}
      <div className={category ? 'pl-2' : ''}>
        {habits.map((habit) => (
          <RowComponent
            key={habit.id}
            habit={habit}
            dates={dates}
            habitNameWidth={category ? habitNameWidth - 8 : habitNameWidth}
          />
        ))}
      </div>
    </div>
